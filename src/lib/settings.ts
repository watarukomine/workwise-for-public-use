...
export const STAFF_GAS_URL = process.env.NEXT_PUBLIC_STAFF_GAS_URL || 'https://script.google.com/macros/s/AKfycbyMJ8Y_-nZz-yWY1ascDwUD8iP1qXmkZTvNBnLXV4bpYT0tyadCDclYnZHZzks4vbLW/exec';

// Customer Data Script (Unified)
export const CUSTOMER_GAS_URL = process.env.NEXT_PUBLIC_CUSTOMER_GAS_URL || 'https://script.google.com/macros/s/AKfycbyMJ8Y_-nZz-yWY1ascDwUD8iP1qXmkZTvNBnLXV4bpYT0tyadCDclYnZHZzks4vbLW/exec';

// Order & Task Management Script (Unified)
export const ORDER_GAS_URL = process.env.NEXT_PUBLIC_ORDER_GAS_URL || 'https://script.google.com/macros/s/AKfycbyMJ8Y_-nZz-yWY1ascDwUD8iP1qXmkZTvNBnLXV4bpYT0tyadCDclYnZHZzks4vbLW/exec';
