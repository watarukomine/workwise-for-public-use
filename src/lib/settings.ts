...
export const STAFF_GAS_URL = process.env.NEXT_PUBLIC_STAFF_GAS_URL || 'https://script.google.com/macros/s/AKfycbxvkpcpimOXL_KEq4CZuapMClNNYlkEJp7disCatEtkcN5Kx_lqMg-gom-yv6GTexzP-A/exec';

// Customer Data Script (Unified)
export const CUSTOMER_GAS_URL = process.env.NEXT_PUBLIC_CUSTOMER_GAS_URL || 'https://script.google.com/macros/s/AKfycbxvkpcpimOXL_KEq4CZuapMClNNYlkEJp7disCatEtkcN5Kx_lqMg-gom-yv6GTexzP-A/exec';

// Order & Task Management Script (Unified)
export const ORDER_GAS_URL = process.env.NEXT_PUBLIC_ORDER_GAS_URL || 'https://script.google.com/macros/s/AKfycbxvkpcpimOXL_KEq4CZuapMClNNYlkEJp7disCatEtkcN5Kx_lqMg-gom-yv6GTexzP-A/exec';
