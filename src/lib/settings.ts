...
// Staff Data Script
export const STAFF_GAS_URL = 'https://script.google.com/macros/s/AKfycbwwTKebqlv7jBggRclXSGwp6BJCAgMVv2MRJxDORnqywA3b_GRDwHodGeOjJXLoE6oL/exec';

// Customer Data Script
export const CUSTOMER_GAS_URL = 'https://script.google.com/macros/s/AKfycbwwTKebqlv7jBggRclXSGwp6BJCAgMVv2MRJxDORnqywA3b_GRDwHodGeOjJXLoE6oL/exec';

// Order & Task Management Script (Unified)
export const ORDER_GAS_URL = "https://script.google.com/macros/s/AKfycbwwTKebqlv7jBggRclXSGwp6BJCAgMVv2MRJxDORnqywA3b_GRDwHodGeOjJXLoE6oL/exec";
