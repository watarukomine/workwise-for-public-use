...
function updateSheetWithOrderInfo(params) {
  const { 
      ...
      actionTimestamp, scheduledTime, taskCalendarEventId, travelCalendarEventId, calendarId
  } = params;
