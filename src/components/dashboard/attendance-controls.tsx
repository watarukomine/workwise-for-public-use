...
export function AttendanceControls({ onStatusChange }: { onStatusChange?: () => void }) {
    ...
    if (isLoading) {
        return <div className="flex items-center gap-2 p-2"><Loader2 className="h-4 w-4 animate-spin" /> 読み込み中...</div>;
    }
